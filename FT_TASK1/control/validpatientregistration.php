...
$fname= $lname= $gender= $Occupation= $age= $bg= $email= $uname= $pass=$Occupationarray ="";
$vfname=$vlname=$vage=$vemail=$vcheckbox=$vradio1=$vradio2=$vpass=$vbg=$vuser=0;
...
if(empty($user))
{
    $validatepass= "Please Enter user";
}
else{
    $validateuser= $user;
    $vuser=1;
