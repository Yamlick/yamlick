...
<html>
    <body>
		...
		<fieldset>
			...
			<input type="radio" name="Occupation" <?php if (isset($Occupation) && $Occupation=="Job")?> value= "job" > 
			<label>job</label>
			<input type="radio" name="Occupation" <?php if (isset($Occupation) && $Occupation=="Worker")?> value= "Worker" > 
			<label>worker</label>
            <input type="radio" name="Occupation" <?php if (isset($Occupation) && $Occupation=="Student")?> value= "Student" > 
			<label>student</label>
